...
// Borra el �ltimo elemento de "xs" y lo devuelve
// Prec.: length(xs) > 0
...
// Agregar un elemento en la posici�n indicada,
// corriendo el resto de los elementos siguientes
// en una posici�n
void addAt(ArrayList& xs, int i, ELEM_TYPE x); // O(n)

// Borra un elemento en la posici�n indicada,
// corriendo el resto de los elementos siguientes
// a una posici�n anterior
